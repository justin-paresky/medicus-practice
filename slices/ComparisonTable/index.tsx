...
const ComparisonTable = ({ slice }: ComparisonTableProps): JSX.Element => {
  const {
    primary: { title, subtitle, description, columns, fullWidth },
  } = slice;
  return (
    <section data-slice-type={slice.slice_type} data-slice-variation={slice.variation} className="bg-blue">
      <ResponsiveContainer fullWidth={fullWidth} className="p-ps flex flex-col gap-16">
        <div className="flex flex-col gap-2 text-center child:text-primary md:text-left">
          ...
          {isFilled.richText(subtitle) && (
            <div className="text-primary child:font-hertine child:text-[2rem] child:font-thin child:leading-[4rem] lg:child:text-5xl">
        ...
        <div className="grid grid-cols-1 grid-rows-3 gap-4 md:grid-cols-4 md:grid-rows-1">
          <div className="hidden flex-col justify-end py-6 pr-8 child:text-primary md:flex md:min-w-[350px]">
            {isFilled.richText(description) && <PrismicRichText field={description} />}
          </div>
            ...
            columns.map((column) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="md:items-left flex w-full flex-col items-center gap-6">
