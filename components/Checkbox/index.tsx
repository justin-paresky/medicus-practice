    ...
    <div className="form-control">
      <label htmlFor={id} className="flex cursor-pointer flex-row items-center justify-start gap-1">
        <input
          aria-labelledby={id}
          type="checkbox"
          className="peer relative h-4 w-4 shrink-0 cursor-pointer appearance-none rounded-[3px] border-[1px] border-gray bg-white focus:outline-none disabled:border-gray-light"
          {...rest}
        />
        <svg
          width="11"
          ...
          className="pointer-events-none absolute left-[2px] hidden h-[10px] w-[11] stroke-white outline-none peer-checked:block"
        >
          <path
